...
public class AliveJobService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        if(Contants.DEBUG)
            Log.d(TAG,"MCS-->AliveJobService-->KeepAliveService----->JobService服务被启动...");
    ...
    public boolean onStopJob(JobParameters params) {
        ...
        if(Contants.DEBUG)
            Log.d(TAG,"MCS-->AliveJobService-->KeepAliveService----->JobService服务被关闭");
        return false;
    }
}

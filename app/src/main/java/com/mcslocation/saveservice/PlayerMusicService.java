...
public class PlayerMusicService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        if(Contants.DEBUG)
            Log.d(TAG,TAG+"MCS-->PlayerMusicService-->onCreate,启动服务");
    ...
    private void startPlayMusic(){
        if(mMediaPlayer != null){
            if(Contants.DEBUG)
                Log.d(TAG,"MCS-->PlayerMusicService-->启动后台播放音乐");
            mMediaPlayer.start();
        }
    }
    ...
    private void stopPlayMusic(){
        if(mMediaPlayer != null){
            if(Contants.DEBUG)
                Log.d(TAG,"MCS-->PlayerMusicService-->关闭后台播放音乐");
            mMediaPlayer.stop();
        }
    }
    ...
    public void onDestroy() {
        ...
        stopPlayMusic();
        if(Contants.DEBUG)
            Log.d(TAG,TAG+"MCS-->PlayerMusicService-->onCreate,停止服务");
        // 重启自己

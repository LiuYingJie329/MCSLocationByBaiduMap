...
import com.mcslocation.activity.SinglePixelActivity;
...
public class ScreenManager {
    ...
    public void startActivity(){
        if(Contants.DEBUG)
            Log.d(TAG,"MCS-->ScreenManager-->准备启动SinglePixelActivity...");
    ...
    public void finishActivity(){
        if(Contants.DEBUG)
            Log.d(TAG,"MCS-->ScreenManager-->准备结束SinglePixelActivity...");
